...
//               </div>
//               <div className="bg-red-500 text-white text-l rounded text-center p-1 m-1">Vidyut Bhavan</div>
//             </Link>
//           </div>
...
import { LogOut, Settings, User, Menu as MenuIcon, X, Phone } from "lucide-react"
import Link from "next/link"
...
export function Navbar() {
  ...
  return (
    <nav className="w-full bg-white shadow-md border-b border-gray-200 relative">
      <div className="w-full mx-auto px-2 sm:px-2 lg:px-8">
        <div className="flex justify-evenly align-center items-center h-30 md:h-25">
          {/* Left: Logo + App Name */}
          <div className="w-1/3 flex items-center justify-center space-x-3">
            ...
            >
              ...
              <div className="bg-red-500 text-white text-l rounded text-center p-1 m-1">
                Vidyut Bhavan
              </div>
            </Link>
          </div>
      ...
      {/* Phone Icon at bottom-right inside Navbar */}
      <Link
        href="tel:8055808899"
        title="For Enquiry"
        className="absolute bottom-2 right-4 flex items-center justify-center bg-red-600 hover:bg-red-700 text-white p-3 rounded-full shadow-md"
      >
